...
public class SchemaVersionDao extends DAOImpl<SchemaVersionRecord, com.ccbcfx.learn.tables.pojos.SchemaVersion, String> {

    /**
     * Create a new SchemaVersionDao without any configuration
     */
    public SchemaVersionDao() {
        super(SchemaVersion.SCHEMA_VERSION, com.ccbcfx.learn.tables.pojos.SchemaVersion.class);
    }
    ...
    public SchemaVersionDao(Configuration configuration) {
        super(SchemaVersion.SCHEMA_VERSION, com.ccbcfx.learn.tables.pojos.SchemaVersion.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(com.ccbcfx.learn.tables.pojos.SchemaVersion object) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByVersionRank(Integer... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByInstalledRank(Integer... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByVersion(String... values) {
     ...
     */
    public com.ccbcfx.learn.tables.pojos.SchemaVersion fetchOneByVersion(String value) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByDescription(String... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByType(String... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByScript(String... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByChecksum(Integer... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByInstalledBy(String... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByInstalledOn(LocalDateTime... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<com.ccbcfx.learn.tables.pojos.SchemaVersion> fetchBySuccess(Byte... values) {
